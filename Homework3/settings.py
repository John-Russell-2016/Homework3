...
#
#  heroku config:set DJANGO_SECRET_KEY='wnc7eg1g%4=s*$fw7h_%229i@ixrfn9q3@25cdentl-9_9bqbn'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'wnc7eg1g%4=s*$fw7h_%229i@ixrfn9q3@25cdentl-9_9bqbn'
...
# if the environment variable is not defined then default to Homework3_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'Homework3_db.sqlite3')),
}
